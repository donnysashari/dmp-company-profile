...
const FALLBACK_FOOTER: FooterType = {
  id: 'fallback',
...
export default function Footer() {
  ...
  const [footerData, setFooterData] = useState<FooterType>(FALLBACK_FOOTER)
  ...
  useEffect(() => {
    if (loading || !footerData.showLogo) return
    ...
    if (logoElement) {
      ...
      gsap.fromTo(logoElement, {
        ...
        opacity: footerData.logoOpacity / 100, // Convert to decimal
        y: 0,
        scale: 1,
        duration: 1.2,
        ease: 'power3.out',
  ...
  }, [loading, footerData.showLogo, footerData.logoOpacity])
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <p className="text-white font-plus-jakarta text-sm font-light leading-relaxed whitespace-pre-line">
                {footerData.address}
              </p>
              ...
              {footerData.email && (
                <p className="text-white font-plus-jakarta text-sm font-light">
                  Email: <a href={`mailto:${footerData.email}`} className="hover:opacity-80 transition-opacity">{footerData.email}</a>
                </p>
              )}
            </div>
          </div>
